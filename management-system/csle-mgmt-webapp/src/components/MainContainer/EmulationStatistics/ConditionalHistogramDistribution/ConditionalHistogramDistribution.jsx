      ...
      for (let i = 0; i < keys.length; i++) {
        ...
        if (props.selectedConditionals.length > 0) {
          for (let j = 0; j < props.selectedConditionals.length; j++) {
            const targetObj = props.data[props.selectedConditionals[j].value][props.selectedMetric.value]

            if (Object.prototype.hasOwnProperty.call(targetObj, keys[i])) {
          ...
          const metricData = props.data[props.selectedMetric.value]

          if (Object.prototype.hasOwnProperty.call(metricData, keys[i])) {
