...
import TransitionProbabilities from './TransitionProbabilities/TransitionProbabilities.jsx'
import ObservationFunction from './ObservationFunction/ObservationFunction.jsx'
import RewardFunction from './RewardFunction/RewardFunction.jsx'
...
const Simulation = (props) => {
  ...
  const player_ids = props.simulation.players_config.player_configs.map((player) => (player.id))
