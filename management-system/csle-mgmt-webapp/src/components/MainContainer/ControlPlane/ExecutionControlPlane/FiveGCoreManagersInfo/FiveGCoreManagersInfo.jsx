                ...
                <div id="hostManagersOpen" className="cardBodyHidden">
                    ...
                    <div className="table-responsive">
                        <Table striped bordered hover>
                            ...
                            <tbody>
                            {props.fiveGCoreManagersOpen.five_g_core_managers_statuses.map((status, index) =>
                                <tr key={`${HOST_MANAGER_SUBRESOURCE}-${index}`}>
                                    ...
                                    <td>
                                        <SpinnerOrButton
                                            ...
                                            running={props.fiveGCoreManagersInfo.host_managers_running[index]}
