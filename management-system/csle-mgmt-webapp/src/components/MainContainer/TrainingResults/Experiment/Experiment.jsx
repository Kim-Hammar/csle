...
import MetricPlot from './MetricPlot/MetricPlot.jsx'
...
import {
  API_BASE_URL, HTTP_REST_POST, LOGIN_PAGE_RESOURCE,
  TOKEN_QUERY_PARAM, FILE_RESOURCE
...
const Experiment = (props) => {
  ...
  }, [navigate, props.sessionData.token, setSessionData, props.experiment.log_file_path])
                  ...
                  <tr>
                    ...
                    <td>
                      <Button variant="link" className="dataDownloadLink"
                              onClick={() => {
                                const blob = new Blob(
                                  [JSON.stringify(props.experiment)],
