 ...
 */
const FiveGCUAppResourceUsageMemoryChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGCUAppResourceUsageMemoryChart.displayName = 'FiveGCUAppResourceUsageMemoryChart'
FiveGCUAppResourceUsageMemoryChart.propTypes = {}
FiveGCUAppResourceUsageMemoryChart.defaultProps = {}
export default FiveGCUAppResourceUsageMemoryChart
