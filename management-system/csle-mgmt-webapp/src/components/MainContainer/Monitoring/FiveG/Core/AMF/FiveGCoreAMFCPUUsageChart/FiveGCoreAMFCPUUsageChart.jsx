...
import './FiveGCoreAMFCPUUsageChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the CPU usage over time for the AMF service in the 5G Core
 */
const FiveGCoreAMFCPUUsageChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGCoreAMFCPUUsageChart.displayName = 'FiveGCoreAMFCPUUsageChart'
FiveGCoreAMFCPUUsageChart.propTypes = {}
FiveGCoreAMFCPUUsageChart.defaultProps = {}
export default FiveGCoreAMFCPUUsageChart
