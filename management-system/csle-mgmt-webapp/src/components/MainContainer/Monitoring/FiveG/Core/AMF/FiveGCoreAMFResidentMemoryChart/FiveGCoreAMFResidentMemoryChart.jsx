...
import './FiveGCoreAMFResidentMemoryChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the resident memory usage over time for the AMF service in the 5G Core
 */
const FiveGCoreAMFResidentMemoryChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGCoreAMFResidentMemoryChart.displayName = 'FiveGCoreAMFResidentMemoryChart'
FiveGCoreAMFResidentMemoryChart.propTypes = {}
FiveGCoreAMFResidentMemoryChart.defaultProps = {}
export default FiveGCoreAMFResidentMemoryChart
