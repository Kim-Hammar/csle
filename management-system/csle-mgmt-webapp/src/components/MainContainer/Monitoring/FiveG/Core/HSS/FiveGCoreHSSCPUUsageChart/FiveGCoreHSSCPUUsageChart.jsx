...
import './FiveGCoreHSSCPUUsageChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the CPU usage over time for the HSS service in the 5G Core
 */
const FiveGCoreHSSCPUUsageChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGCoreHSSCPUUsageChart.displayName = 'FiveGCoreHSSCPUUsageChart'
FiveGCoreHSSCPUUsageChart.propTypes = {}
FiveGCoreHSSCPUUsageChart.defaultProps = {}
export default FiveGCoreHSSCPUUsageChart
