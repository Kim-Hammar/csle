...
import './FiveGCoreAMFVirtualMemoryChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the virtual memory usage over time for the AMF service in the 5G Core
 */
const FiveGCoreAMFVirtualMemoryChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGCoreAMFVirtualMemoryChart.displayName = 'FiveGCoreAMFVirtualMemoryChart'
FiveGCoreAMFVirtualMemoryChart.propTypes = {}
FiveGCoreAMFVirtualMemoryChart.defaultProps = {}
export default FiveGCoreAMFVirtualMemoryChart
