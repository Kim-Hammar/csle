...
import './FiveGCoreHSSResidentMemoryChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the resident memory usage over time for the HSS service in the 5G Core
 */
const FiveGCoreHSSResidentMemoryChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGCoreHSSResidentMemoryChart.displayName = 'FiveGCoreHSSResidentMemoryChart'
FiveGCoreHSSResidentMemoryChart.propTypes = {}
FiveGCoreHSSResidentMemoryChart.defaultProps = {}
export default FiveGCoreHSSResidentMemoryChart
