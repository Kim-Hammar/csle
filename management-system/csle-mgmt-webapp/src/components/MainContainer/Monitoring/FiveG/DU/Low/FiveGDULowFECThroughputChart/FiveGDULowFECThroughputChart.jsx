...
import './FiveGDULowFECThroughputChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the Forward Error Correction throughput (mbps) over time
 */
const FiveGDULowFECThroughputChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
    ...
    if (props.stats !== undefined && props.stats.length > 0) {
      const data = props.stats.map((five_g_du_low_metrics, index) => {
        return {
          't': (index + 1),
          'DL': parseFloat(five_g_du_low_metrics.dl_fec_tput_mbps),
          'UL': parseFloat(five_g_du_low_metrics.ul_fec_tput_mbps)
        }
      })
        ...
        <div style={{ height: 300 }}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <YAxis type="number">
                <Label angle={270} value="Throughput (mbps)" offset={0} position="insideLeft"
                       className="largeFont"
                       dy={50} />
              </YAxis>
              <Tooltip />
...
FiveGDULowFECThroughputChart.displayName = 'FiveGDULowFECThroughputChart'
FiveGDULowFECThroughputChart.propTypes = {}
FiveGDULowFECThroughputChart.defaultProps = {}
export default FiveGDULowFECThroughputChart
