...
import './FiveGDULowSINRChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the average signal to noise ration of the uplink over time
 */
const FiveGDULowSINRChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
    ...
    if (props.stats !== undefined && props.stats !== null && props.stats.length > 0) {
      const data = props.stats.map((five_g_du_low_metrics, index) => {
        return {
          't': (index + 1),
          'SINR': parseFloat(five_g_du_low_metrics.ul_sinr_db),
        }
      })
        ...
        <div style={{ height: 300 }}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <YAxis type="number">
                <Label angle={270} value="Signal to noise ratio (dB)" offset={0} position="insideLeft"
                       className="largeFont"
                       dy={50} />
              </YAxis>
              <Tooltip />
...
FiveGDULowSINRChart.displayName = 'FiveGDULowCPUUsageChart'
FiveGDULowSINRChart.propTypes = {}
FiveGDULowSINRChart.defaultProps = {}
export default FiveGDULowSINRChart
