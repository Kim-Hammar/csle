...
import './FiveGDUCellBlockErrorRateChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
 ...
 */
const FiveGDUCellBlockErrorRateChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
    ...
    if (props.stats !== undefined && props.stats !== null && props.stats.length > 0) {
      const data = props.stats.map((five_g_du_cell_metrics, index) => {
        return {
          't': (index + 1),
          'DL': parseFloat(five_g_du_cell_metrics.dl_bler),
          'UL': parseFloat(five_g_du_cell_metrics.ul_bler)
        }
      })
        ...
        <div style={{ height: 300 }}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <YAxis type="number">
                <Label angle={270} value="Block error rate" offset={0} position="insideLeft"
                       className="largeFont"
                       dy={50} />
              </YAxis>
              <Tooltip />
...
FiveGDUCellBlockErrorRateChart.displayName = 'FiveGDUCellBlockErrorRateChart'
FiveGDUCellBlockErrorRateChart.propTypes = {}
FiveGDUCellBlockErrorRateChart.defaultProps = {}
export default FiveGDUCellBlockErrorRateChart
