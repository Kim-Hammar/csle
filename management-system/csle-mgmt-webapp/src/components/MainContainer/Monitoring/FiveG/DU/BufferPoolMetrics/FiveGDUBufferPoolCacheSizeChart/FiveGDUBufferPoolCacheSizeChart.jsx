...
import './FiveGDUBufferPoolCacheSizeChart.css'
import {
  CartesianGrid,
  Label,
  Legend, Line,
...
/**
 * Component containing a plot showing the central cache size over time for the 5G DU
 */
const FiveGDUBufferPoolCacheSizeChart = React.memo((props) => {
    const margin = {
      top: 10,
      right: 30,
      left: 15,
...
FiveGDUBufferPoolCacheSizeChart.displayName = 'FiveGDUBufferPoolCacheSizeChart'
FiveGDUBufferPoolCacheSizeChart.propTypes = {}
FiveGDUBufferPoolCacheSizeChart.defaultProps = {}
export default FiveGDUBufferPoolCacheSizeChart
