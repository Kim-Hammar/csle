...
def default_five_g_config(network_id: int, level: int, version: str, time_step_len_seconds: int) \
    ...
    config = FiveGConfig(
        ...
        ], core_ip=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}.3.50"
    )
    return config
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level16-090", network_id=16, level=16, version="0.9.0", time_step_len_seconds=30)
