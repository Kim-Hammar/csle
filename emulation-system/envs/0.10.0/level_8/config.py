...
def default_config(name: str, network_id: int = 8, level: int = 8, version: str = "0.10.0",
...
def default_resource_constraints_config(network_id: int, level: int) -> ResourcesConfig:
    ...
    node_resources_configurations = [
        ...
        NodeResourcesConfig(
            container_name=f"{constants.CSLE.NAME}-"
                           f"{constants.CONTAINER_IMAGES.CVE_2015_5602_1}_2-{constants.CSLE.LEVEL}"
                           f"{level}",
            num_cpus=1, available_memory_gb=4,
            ips_and_network_configs=[
                (f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}.12.61",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level8-0.10.0", network_id=8, level=8, version="0.10.0",
