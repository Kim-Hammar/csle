import csle_collector.five_g_du_manager.five_g_du_manager as five_g_du_manager
import argparse

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("-p", "--port", help="the port to start the five_g_du_manager server", type=int)
    ...
    five_g_du_manager.serve(port=args.port, log_dir=args.logdir, max_workers=args.maxworkers,
