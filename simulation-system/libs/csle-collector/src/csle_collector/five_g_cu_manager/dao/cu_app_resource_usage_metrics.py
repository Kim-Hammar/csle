...
class CUAppResourceUsageMetrics(JSONSerializable):
    """
    ...
    @staticmethod
    def from_kafka_record(record: str) -> "CUAppResourceUsageMetrics":
        """
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "CUAppResourceUsageMetrics":
        """
    ...
    @staticmethod
    def from_ws_dict(d: Dict[str, Any], ip: str) -> "CUAppResourceUsageMetrics":
        """
    ...
    def copy(self) -> "CUAppResourceUsageMetrics":
        """
        :return: a copy of the object
        """
        c = CUAppResourceUsageMetrics(
    ...
    @staticmethod
    def schema() -> "CUAppResourceUsageMetrics":
        """
        :return: get the schema of the DTO
        """
        return CUAppResourceUsageMetrics()

    @staticmethod
    def from_json_file(json_file_path: str) -> "CUAppResourceUsageMetrics":
        """
        ...
        with io.open(json_file_path, 'r') as f:
            json_str = f.read()
        return CUAppResourceUsageMetrics.from_dict(json.loads(json_str))
