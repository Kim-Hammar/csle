...
class BufferPoolMetrics(JSONSerializable):
    """
    ...
    @staticmethod
    def from_kafka_record(record: str) -> "BufferPoolMetrics":
        """
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "BufferPoolMetrics":
        """
    ...
    @staticmethod
    def from_ws_dict(d: Dict[str, Any], ip: str) -> "BufferPoolMetrics":
        """
    ...
    def copy(self) -> "BufferPoolMetrics":
        """
    ...
    @staticmethod
    def from_json_file(json_file_path: str) -> "BufferPoolMetrics":
        """
        ...
        with io.open(json_file_path, 'r') as f:
            json_str = f.read()
        return BufferPoolMetrics.from_dict(json.loads(json_str))