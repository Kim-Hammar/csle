...
class DUMonitorThread(threading.Thread):
    ...
    def __init__(self, kafka_ip: str, kafka_port: int, ip: str, hostname: str,
        ...
        logging.info(
            f"DU Monitor thread initialized. Target: {self.ip}:{self.du_port}, Interval: {self.time_step_len_seconds}s")
    ...
    def _on_open(self, ws) -> None:
        ...
        :return: None
        """
        logging.info(f"[DU Monitor] Connected to {self.ip}.")
    ...
    def _on_message(self, ws, message):
        ...
        try:
            ...
            logging.error("[DU Monitor] Received non-JSON message")
        except Exception as e:
            logging.error(f"[DU Monitor] Error parsing message: {e}")
    ...
    def _on_close(self, ws, close_status_code, close_msg) -> None:
        ...
        :return: None
        """
        logging.warning(f"[DU Monitor] WebSocket Closed: {close_msg}")
    ...
    def _run_ws_client(self):
        ...
        while self.running:
            try:
                logging.info(f"[DU Monitor] Connecting WS to {ws_url}...")
                ...
                logging.error(f"[DU Monitor] WS Connection failed: {e}")
    ...
    def run(self) -> None:
        ...
        while self.running:
            ...
            try:
                ...
                logging.error(f"[DU Monitor] Error in reporting loop: {e}")
