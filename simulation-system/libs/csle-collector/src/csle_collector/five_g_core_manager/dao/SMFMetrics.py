...
class SMFMetrics(JSONSerializable):
    ...
    def to_kafka_record(self, ip: str) -> str:
        ...
        record_str = (f"{ts},{ip},{self.gn_rx_createpdpcontextreq},{self.gn_rx_deletepdpcontextreq},"
                      ...
                      f"{self.fivegs_smffunction_sm_n4sessionreportsucc},{self.fivegs_smffunction_sm_n4sessionestabreq},"
                      ...
                      f"{self.fivegs_smffunction_sm_n4sessionestabfail},{self.fivegs_smffunction_sm_pdusessioncreationfail},"
