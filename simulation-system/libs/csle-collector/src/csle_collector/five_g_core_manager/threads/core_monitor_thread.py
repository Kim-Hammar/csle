...
class CoreMonitorThread(threading.Thread):
    """
    ...
    def __init__(self, kafka_ip: str, kafka_port: int, ip: str, hostname: str, time_step_len_seconds: int) -> None:
        ...
        self.running = True
        logging.info("CoreMonitor thread started successfully")
    ...
    def run(self) -> None:
        ...
        :return: None
        """
        logging.info("CoreMonitor [Running]")
        while self.running:
