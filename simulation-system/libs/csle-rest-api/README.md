...
| `/emulation-executions/<execution_id>/core-monitor?token=<valid_token>&emulation=<emulation>`         | Start/stop 5G core monitors of an emulation execution          | `POST`                                  |
...
| `/emulation-executions/<execution_id>/cu-monitor?token=<valid_token>&emulation=<emulation>`           | Start/stop 5G CU monitors of an emulation execution            | `POST`                                  |
...
| `/emulation-executions/<execution_id>/du-monitor?token=<valid_token>&emulation=<emulation>`           | Start/stop 5G DU monitors of an emulation execution            | `POST`                                  |
