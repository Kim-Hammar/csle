...
| `/emulation-executions/<exec_id>/five-g-core-monitor?token=<token>&emulation=<em>` | `POST`                 |
| `/logs/five-g-cu-manager?token=<token>&emulation=<em>&executionid=<exec_id>`       | `POST`                 |
| `/emulation-executions/<exec_id>/five-g-cu-monitor?token=<token>&emulation=<em>`   | `POST`                 |
| `/logs/five-g-du-manager?token=<token>&emulation=<em>&executionid=<exec_id>`       | `POST`                 |
| `/emulation-executions/<exec_id>/five-g-du-monitor?token=<token>&emulation=<em>`   | `POST`                 |
