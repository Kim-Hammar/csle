...
| `/emulation-executions/<exec_id>/core-monitor?token=<token>&emulation=<em>`    | `POST`                 |
| `/logs/five-g-cu-manager?token=<token>&emulation=<em>&executionid=<exec_id>`   | `POST`                 |
| `/emulation-executions/<exec_id>/cu-monitor?token=<token>&emulation=<em>`      | `POST`                 |
| `/logs/five-g-du-manager?token=<token>&emulation=<em>&executionid=<exec_id>`   | `POST`                 |
| `/emulation-executions/<exec_id>/du-monitor?token=<token>&emulation=<em>`      | `POST`                 |
