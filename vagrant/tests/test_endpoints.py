...
class TestAPIEndpoints:
    ...
    def test_emulations_endpoint(self, api_base_url, auth_token, in_vagrant):
        ...
        assert response.status_code == 200, f"Emulations endpoint failed: {response.status_code}"
    ...
    def test_simulations_endpoint(self, api_base_url, auth_token, in_vagrant):
        ...
        assert response.status_code == 200, f"Simulations endpoint failed: {response.status_code}"
...
class TestMonitoringEndpoints:
    ...
    def test_grafana_health(self, grafana_url, in_vagrant):
        ...
        try:
            ...
            pytest.fail(f"Could not connect to Grafana at {grafana_url}")
    ...
    def test_node_exporter_metrics(self, node_exporter_url, in_vagrant):
        ...
        try:
            ...
            pytest.fail(f"Could not connect to Node Exporter at {node_exporter_url}")
